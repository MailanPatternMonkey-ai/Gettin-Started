...
- Simulation Protocol v0.3 — a CC0 methods/protocol release candidate for the three-dimensional Z_2-gauged XY model
- Eleven A.10 validation scaffold files covering canonical extraction, frozen geometry, transition rules, invariant tests, enumeration, sector transforms, partition ratios, detailed balance, blind mixing, comparator checks, and build provenance
